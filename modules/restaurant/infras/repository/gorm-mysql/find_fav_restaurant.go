...
func (r *RestaurantRepo) FindFavRestaurant(ctx context.Context, req restaurantmodel.FavoriteRestaurantListReq) ([]restaurantmodel.RestaurantSearchResDto, int64, error) {
	...
	var results []restaurantmodel.RestaurantSearchResDto
	var total int64
