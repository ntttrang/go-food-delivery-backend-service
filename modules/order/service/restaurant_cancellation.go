...
func (s *OrderNotificationService) createRestaurantOrderCancelledMessage(orderID, reason string, order *ordermodel.Order, tracking *ordermodel.OrderTracking, orderDetails []ordermodel.OrderDetail) (string, string) {
